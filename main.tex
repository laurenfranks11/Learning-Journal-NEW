...
\addcontentsline{toc}{section}{Using LaTex and Overleaf}
\chapsubhead{Using LaTex and Overleaf}\\
Objective: Make code stand out in LaTex document\\
Action: Tried \ command\\
Result: Successfully highlighted code\\
Error: However overleaf through I wanted to use the command\\

\addcontentsline{toc}{section}{uMatrix}
\chapsubhead{uMatrix}\\
...
Objective: Figure out how to use whitelist function on uMatrix
